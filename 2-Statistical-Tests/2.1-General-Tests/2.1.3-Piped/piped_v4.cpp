...
// KS test
void Test_ks(mp_bitcnt_t m2exp, gmp_randstate_t state = NULL)
{
...
// ChiSquare test
void Test_cs(mp_bitcnt_t m2exp, gmp_randstate_t state = NULL)
{
    unsigned long int i; // loop iterator
...
void Test_all(mp_bitcnt_t m2exp, gmp_randstate_t state = NULL)
{
    unsigned long int i; // loop iterator
